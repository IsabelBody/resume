...
%---------------------------------------------------------
\cventry
  {Stock Market Prediction Model} % Project
  {2024} % Date(s)
  % {} % Location
  {
    \begin{cvitems} % Description(s) of project
      \item {Leveraged historical data and machine learning algorithms to estimate upcoming change in the US Stock market.}
      \item {Built using Pandas, numpy, and sklearn from public data on Yahoo Finance for the S\&P 500.}
    \end{cvitems}
  }
...
%---------------------------------------------------------
  \cventry
    ...
    {Face-Analyser tool} % Organisation
    {2023} % Date(s)
    % {} % Location
    {
      \begin{cvitems} % Description(s) of project
        \item {Implemented an emotion, gender, and race detecting computer vision project using OpenCV and deepface Python libraries.}
        \item {Designed multi-threading algorithms to reduce network overloading issues by 96\%, enabling real-time analysis of facial attributes.}
  ...
  \cventry
    ...
    {Game Library App} % Project
    {2023} % Date(s)
    % {} % Location
    {
      \begin{cvitems} % Description(s) of project
        \item {Led the development of a comprehensive game library using MVVM design pattern, implementing Python with Flask and SQLAlchemy.}
        \item {Utilised Agile project management strategies, including creating timelines to ensure project milestones were met and facilitating strength-based delegation among team members.}
        \item {Implemented proxy rotation algorithm that uses resource consumption and HTTP request routing metrics to rotate proxies on a per thread basis to optimise parallel processing of HTTP traffic.}
      \end{cvitems}
    }
...
%     {
%       \begin{cvitems} % Description(s) of project
%         \item {Tasks incorporated in General Hospital to perform transport operations with possible non-static obstacles in the path.}
...
%---------------------------------------------------------
  % \cventry
  %   {e-Yantra, International Robotics Competition} % Organisation
  ...
  %       %\item {Awarded as one of the National Finalists. Senior academic professors appreciated for creating a {\bf robust robotic prototype} model.}
  %     \end{cvitems}
  %   }
